...
const stats = [
  { icon: Code, label: "Projects, Solo-Built & Deployed", value: "2" },
      ...
      <div className="grid lg:grid-cols-5 gap-8 items-start">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            My portfolio spans a property rental platform, AI-assisted campus tooling, and automated video generation — two built solo and deployed on Vercel and Render, one led as the primary frontend contributor on a college team. I'm comfortable across the stack: REST API design, authentication, relational and NoSQL databases, and applied ML including AI voiceover generation and matching algorithms.
          </p>
